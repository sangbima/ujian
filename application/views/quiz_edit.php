			...
			<form method="post" action="<?php echo site_url('quiz/update_quiz/'.$quiz['quid']);?>">
				<div class="login-panel panel panel-default">
					...
					<div class="panel-body">
						...
						<?php } else {?>
							<input type="hidden" name="gen_certificate" value=<?php echo $quiz['gen_certificate']?> >
							<input type="hidden" name="certificate_text" value=<?php echo $quiz['certificate_text'];?>>
						<?php }?>
						<hr>
						<br><br><br>
						<?php if($quiz['question_selection']=='0'){ ?>
						...
						<table class="table table-bordered" style="margin-top:10px;">
							...
							<tr>
								...
								<td>
									...
									<?php } ?>
							  		<?php if($key==(count(explode(',',$quiz['qids']))-1)){ ?>
									<?php }else{ ?>
						...
						<?php if(count($qcl)==0){ echo $this->lang->line('no_question_added').'<br><br>'; }	?>
						<?php foreach($qcl as $k => $vall){ ?>
						<div class="form-group">	 
				 			<select   name="cid[]" >
					...
					<div class="panel-footer">
						<button class="btn btn-success btn-special" type="submit"><?php echo $this->lang->line('submit');?></button>
					</div>
...
<div id="warning_div" style="padding:10px; position:fixed;z-index:100;display:none;width:100%;border-radius:5px;height:200px; border:1px solid #dddddd;left:4px;top:70px;background:#ffffff;">
	<center>
		<b><?php echo $this->lang->line('to_which_position');?></b><br><input type="text" style="width:30px" id="qposition" value=""><br><br>
		<a href="javascript:cancelmove();"   class="btn btn-danger btn-special"  style="cursor:pointer;"><?php echo $this->lang->line('cancel');?></a> &nbsp; &nbsp; &nbsp; &nbsp;
		<a href="javascript:movequestion();"   class="btn btn-info btn-special"  style="cursor:pointer;"><?php echo $this->lang->line('move');?></a>
	</center>
</div>
